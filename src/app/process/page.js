...
export default function Projects() {
  return (
    <>
    <Navbar name={"process"} />
    <main className="bg-white text-text overflow-y-scroll p-8 gap-6 items-center justify-center flex min-h-screen w-full md:w-[70vw] fixed top-0 right-0 bottom-0 flex-col items-center">
      ...
      <div className="flex">
        <div className="flex flex-col mt-4 gap-8 lg:gap-20 h-full justify-between">
          <div className="items-center rounded-xl h-full flex  w-full bg-black p-1 sm:p-4">
