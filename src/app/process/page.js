...
export default function Projects() {
  return (
    <>
    <Navbar name={"process"} />
    <main className="bg-whiteBg text-text gap-6 lg:px-16 items-center justify-center flex min-h-screen w-full md:w-[70vw] fixed top-0 right-0 bottom-0 flex-col items-center  p-4">
      ...
      <div className="flex gap-2">
        <div className="flex flex-col mt-4 gap-8 lg:gap-20 sm:p-4 lg:p-8 h-full bg-gradient-to-r from-gradTop to-gradBottom justify-between items-center p-2">
          <div className="h-full md:max-w-[5vw] items-center justify-center flex">
